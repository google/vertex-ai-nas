...
from tf1.detection.modeling import learning_rates
from tf1.detection.utils import benchmark_utils
...
def filter_variables(variables, variable_regex, is_allowlist):
  ...
  Args:
    ...
    is_allowlist: a bool. If True, indicate `variable_regex` specifies the
