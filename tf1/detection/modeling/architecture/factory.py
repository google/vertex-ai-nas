...
def backbone_generator(params):
  ...
  if params.architecture.backbone == 'resnet':
    ...
    if mnasnet_params.block_specs:
      block_specs_list = json.loads(mnasnet_params.block_specs)
...
def multilevel_features_generator(params):
  ...
  elif params.architecture.multilevel_features == 'tunable_nasfpn_v1':
    nasfpn_params = params.tunable_nasfpn_v1
    fpn_fn = tunable_nasfpn.model_v1(
        min_level=params.architecture.min_level,
        max_level=params.architecture.max_level,
        feature_dims=nasfpn_params.fpn_feat_dims,
        num_repeats=nasfpn_params.num_repeats,
        use_separable_conv=nasfpn_params.use_separable_conv,
        dropblock=dropblock_generator(params.dropblock),
        batch_norm_relu=batch_norm_activation_generator(
            params.batch_norm_activation),
        nodes=nasfpn_params.nodes)
  elif params.architecture.multilevel_features == 'tunable_nasfpn_v2':
    nasfpn_params = params.tunable_nasfpn_v2
    fpn_fn = tunable_nasfpn.tunable_nasfpn_builder(
        min_level=params.architecture.min_level,
        max_level=params.architecture.max_level,
        block_specs_json=nasfpn_params.block_specs,
        fpn_feat_dims=nasfpn_params.fpn_feat_dims,
        num_repeats=nasfpn_params.num_repeats,
        use_separable_conv=nasfpn_params.use_separable_conv,
        activation=params.batch_norm_activation.activation,
