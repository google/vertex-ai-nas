...
from tf_vision.pointpillars.dataloaders import parsers
from tf_vision.pointpillars.modeling import factory
from tf_vision.pointpillars.utils import utils
from official.vision.beta.dataloaders import input_reader_factory
from official.vision.keras_cv.losses import focal_loss
from official.vision.keras_cv.losses import loss_utils


def pick_dataset_fn(file_type):
...
def get_batch_size_per_replica(global_batch_size):
  ...
  def build_metrics(self, training = True):
    ...
    if not training:
      if self.task_config.use_wod_metrics:
        ...
        # currently used.
        try:
          from tf_vision.pointpillars.utils import wod_detection_evaluator  # pylint: disable=g-import-not-at-top
