...
class WodProcessor:
  ...
  def _convert_range_image_to_point_cloud(
    ...
    for calibration in calibrations:
      ...
      intensity_tensor = range_image_tensor[Ellipsis, 1:2]
      elongation_tensor = range_image_tensor[Ellipsis, 2:3]
      ...
      distance_mask = range_image_tensor[Ellipsis, 0] > 0
      nlz_mask = range_image_tensor[Ellipsis, 3] == -1.0
  ...
  def compute_pillars(
    ...
    # (p, n, 3)
    pillar_xyz = pillar_points[Ellipsis, 0:3]
    # (p, n, f-3)
    pillar_others = pillar_points[Ellipsis, 3:]
    # (p, 1, 3)
  ...
  def _adjust_label_type(self, label):
  ...
  def _adjust_difficulty_level(self, label):
