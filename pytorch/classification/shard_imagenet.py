...
--max_images_per_shard=625

NOTE: It's best to make each tar file contain almost the same number of
individual images, and to make the number of tar files be the multiple of the
number of processes used by webdataset during training.
For example, with 4 GPUs and 2 dataloader workers (8 processes), we shard
50K images into 80 tar files, each tar file contains 625 images.
"""
