...
RUN mv third_party/tutorial/tutorial4_mnist_search_with_latency_constraint.py tutorial4_mnist_search_with_latency_constraint.py
ENTRYPOINT ["python", "tutorial4_mnist_search_with_latency_constraint.py"]
